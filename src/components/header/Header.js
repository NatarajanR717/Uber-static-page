  ...
  return (
    <div className="container">
      ...
      <div className="menu-right">
        <ul>
          <li>
            <a href="./">Company <svg width="24" height="18" viewBox="0 0 24 24" fill="none"><path d="M18 8v3.8l-6 4.6-6-4.6V8l6 4.6L18 8Z" fill="currentColor"></path></svg></a>
          </li>
          <li>
            <a href="./">Safety</a>
          </li>
